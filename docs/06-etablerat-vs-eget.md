...
| Täckningskrav 0,5 | **Egen – problematisk** | Absolut krav på 0,5 Hz, inte relativ täckning. Gles inspelning (smart recording) ger `N/A` överallt, utan förklaring. | [FA-2](10-fel-fit-analysis.md) |
...
| TSS-ackumuleringskurva | **Egen – problematisk** | Full omräkning var 30:e sekund, inte löpande summa. **Planar aldrig ut** (växer som √t): 1,6–3,7× för stort tillskott. Lutningen är det tolkbara. | [FA-3](10-fel-fit-analysis.md) |
...
| Binärsökning 105–150 % av CP | **Egen – problematisk** | Klipper tyst vid gränserna. Biter bara för `2×15 min`, som då föreskrivs som ogenomförbart (slut-W′bal −155 J). | [WB-2](09-fel-wbal.md) |
...
uppmätt storlek i [09 — Fel i wbal](09-fel-wbal.md) och [10 — Fel i fit-analysis](10-fel-fit-analysis.md);
fellistorna [07](07-fel-power-curve.md)–[10](10-fel-fit-analysis.md) ger översikten över alla fel.

1. **Ta bort 30 W-golvet för nollor** ([FA-1](10-fel-fit-analysis.md)).
...
2. **Fixa täckningskravet** ([FA-2](10-fel-fit-analysis.md)).
...
3. **Begränsa bottennivån, inte bara slutvärdet, och varna vid klippning**
   ([WB-2](09-fel-wbal.md)–B2). Verktyget föreskriver pass som enligt dess egen modell
   är ogenomförbara, omarkerade.
4. **Flytta återhämtningsfaktorn in i τ** ([WB-3](09-fel-wbal.md)).
...
5. **Byt "area under kurvan" mot `TP·3600 + HIE`** ([PC-1](07-fel-power-curve.md)).
   Ersätter ett tal som är 12,3 % för högt och dessutom rör sig 10 % med en godtyckligt
   vald integrationsgräns.

Därefter: relativa mål i passchemat ([FA-6](10-fel-fit-analysis.md)), etiketten
